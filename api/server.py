...
api.add_resource(UserIsRoleController,
                 '/user/<int:user_id>/role/<int:role_id>')
api.add_resource(UserParticipatesActivityController,
                 '/user/<int:user_id>/activity/<int:activity_id>')
api.add_resource(UserFollowsCourseController,
                 '/user/<int:user_id>/course/<int:course_id>')
