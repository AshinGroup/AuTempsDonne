...
class EventService:
    ...
    def insert(self, args: dict):
        new_event = Event(name=args['name'], datetime=args['datetime'], description=args['description'], capacity=args['capacity'], group=args['group'], type_id=args['type_id'])
    ...
    def update(self, event_id: int, args: dict):
        update_event = Event(name=args['name'], datetime=args['datetime'], description=args['description'], capacity=args['capacity'], group=args['group'], type_id=args['type_id'])
        event = self.event_repo.select_one_by_id(event_id=event_id)
        ...
        self.event_repo.update(event_id=event.event_id, update_event=update_event)
