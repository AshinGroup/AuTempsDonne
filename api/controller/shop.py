...
class ShopCheckArgs:
    ...
    def get_shop_args(self) -> dict:
        ...
        parser.add_argument('name', type=int, required=True, help="Invalid or missing parameter 'name'.")
        parser.add_argument('company_id', type=int, required=True, help="Invalid or missing parameter 'company_id'.")
