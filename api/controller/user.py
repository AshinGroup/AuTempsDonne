...
class UserCheckArgs:
    ...
    def get_user_args(self) -> dict:
        ...
        parser.add_argument('role_id', type=int,
                            help="Invalid or missing parameter 'role'")
        parser.add_argument('password', type=inputs.regex(
            self.pattern['password']), required=True, help="Invalid or missing parameter 'password'")
        parser.add_argument('status', type=int, required=True,
                            help="Invalid or missing parameter 'status'")
...
class UserParticipatesActivityController(Resource):
    ...
    def post(self, user_id: int, activity_id: int) -> None:
        try:
            self.user_service.insert_activity(
    ...
    def delete(self, user_id: int, activity_id: int) -> None:
        try:
            self.user_service.delete_activity(
                user_id=user_id, activity_id=activity_id)
...
class UserFollowsCourseController(Resource):
    ...
    def post(self, user_id: int, course_id: int) -> None:
        try:
            self.user_service.insert_course(
    ...
    def delete(self, user_id: int, course_id: int) -> None:
        try:
            self.user_service.delete_course(
                user_id=user_id, course_id=course_id)
